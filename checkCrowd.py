# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 16:21:41 2021
...
def checkCrowdER(entity,relation,graph, WDT, WD, cleanCrowd, aggAns, numCnt, irate):
    ...
    entid = ge.getEntIdByURI(WD, entURI[0])
...
def checkCrowdEE(entity1,entity2,graph, WDT, WD, cleanCrowd, aggAns, numCnt, irate):
    ge = getEntity()
    entURI1 = ge.getEntURI(graph, entity1)
    entid1 = ge.getEntIdByURI(WD, entURI1[0])
    
    entURI2 = ge.getEntURI(graph, entity2)
    entid2 = ge.getEntIdByURI(WD, entURI2[0])
